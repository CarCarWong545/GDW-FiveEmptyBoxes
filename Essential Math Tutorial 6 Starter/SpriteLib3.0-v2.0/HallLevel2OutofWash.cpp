...
HallLevel2OutofWash::HallLevel2OutofWash(std::string name)
	: Scene(name)
{
...
int HallLevel2OutofWash::ChangeScene()
{
...
void HallLevel2OutofWash::InitScene(float windowWidth, float windowHeight)
{
...
void HallLevel2OutofWash::Update()
{
...
void HallLevel2OutofWash::KeyboardHold()
{
...
void HallLevel2OutofWash::KeyboardDown()
{
	auto& player = ECS::GetComponent<PhysicsBody>(MainEntities::MainPlayer());
...
void HallLevel2OutofWash::KeyboardUp()
{
}
