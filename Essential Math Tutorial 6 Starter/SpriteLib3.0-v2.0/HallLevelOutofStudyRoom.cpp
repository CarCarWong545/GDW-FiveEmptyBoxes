//#include "Game.h"
#include "Utilities.h"
#include "HallLevelOutofStudyRoom.h"
#include "HealthBar.h"
...
HallLevelOutofStudyRoom::HallLevelOutofStudyRoom(std::string name)
	: Scene(name)
{
...
int HallLevelOutofStudyRoom::ChangeScene()
{
...
void HallLevelOutofStudyRoom::InitScene(float windowWidth, float windowHeight)
{
	...
	//luigi entity
	{
		...
		tempDef.position.Set(float32(145.f), float32(0.f));
...
void HallLevelOutofStudyRoom::Update()
{
...
void HallLevelOutofStudyRoom::KeyboardHold()
{
...
void HallLevelOutofStudyRoom::KeyboardDown()
{
	auto& player = ECS::GetComponent<PhysicsBody>(MainEntities::MainPlayer());
...
void HallLevelOutofStudyRoom::KeyboardUp()
{
}
