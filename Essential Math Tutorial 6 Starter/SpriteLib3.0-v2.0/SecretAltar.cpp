...
SecretAltar::SecretAltar(std::string name)
	:Scene(name)
{
...
void SecretAltar::InitScene(float windowWidth, float windowHeight)
{
	...
	//Setup new Entity
	{
		...
		std::string fileName = "SecretAltar.png";
	...
	Scene::BoxMaker(200, 10, 30, -10, 90, 0);
	{
