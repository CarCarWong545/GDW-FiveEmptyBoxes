//#include "Game.h"
#include "Utilities.h"
#include "HallLevelOutofMaster.h"
#include "HealthBar.h"
...
HallLevelOutofMaster::HallLevelOutofMaster(std::string name)
	: Scene(name)
{
...
int HallLevelOutofMaster::ChangeScene()
{
...
void HallLevelOutofMaster::InitScene(float windowWidth, float windowHeight)
{
	...
	//luigi entity
	{
		...
		tempDef.position.Set(float32(-80.f), float32(0.f));
...
void HallLevelOutofMaster::Update()
{
...
void HallLevelOutofMaster::KeyboardHold()
{
...
void HallLevelOutofMaster::KeyboardDown()
{
	auto& player = ECS::GetComponent<PhysicsBody>(MainEntities::MainPlayer());
...
void HallLevelOutofMaster::KeyboardUp()
{
}
