...
void HallLevel::InitScene(float windowWidth, float windowHeight)
{
	...
	Scene::BoxMaker(325, 2, 0.f, 0.f, -20, 0);
	...
	//door trigger 1
	{
		...
		tempDef.position.Set(float32(50.f), float32(70.f));
