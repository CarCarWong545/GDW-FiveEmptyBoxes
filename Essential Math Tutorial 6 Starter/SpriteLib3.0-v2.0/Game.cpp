...
void Game::InitGame()
{
	...
	m_scenes.push_back(new ReturnFoyer2("Foyer ")); // 14 placeholder Main Menu
	m_scenes.push_back(new ReturnFoyer2("Foyer ")); // 15 placeholder for testin should be Final Thanks for Playing Image
