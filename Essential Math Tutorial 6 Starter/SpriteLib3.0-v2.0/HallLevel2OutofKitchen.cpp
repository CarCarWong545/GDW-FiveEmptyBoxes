#include "Utilities.h"
#include "HallLevel2OutofKitchen.h"
#include "HealthBar.h"
...
HallLevel2OutofKitchen::HallLevel2OutofKitchen(std::string name)
	: Scene(name)
{
...
int HallLevel2OutofKitchen::ChangeScene()
{
...
void HallLevel2OutofKitchen::InitScene(float windowWidth, float windowHeight)
{
...
void HallLevel2OutofKitchen::Update()
{
...
void HallLevel2OutofKitchen::KeyboardHold()
{
...
void HallLevel2OutofKitchen::KeyboardDown()
{
	auto& player = ECS::GetComponent<PhysicsBody>(MainEntities::MainPlayer());
...
void HallLevel2OutofKitchen::KeyboardUp()
{
}
